...
export const primitive = {
  ...
  opacity: {
    red: { light: "#FFEBEF00", dark: "#D10A4633" },
    dim: "#22222299",
    black: "#22222226",
    orange: "#E0791280",
  },
...
export interface ColorScheme {
  ...
  /* NEW — BUTTON SURFACES */
  buttons: {
    surface: string; // grey button
    surfacePrimary: string; // black/white primary button
...
const lightColors: ColorScheme = {
  ...
  checklist: {
    surface: { primary: [primitive.grey[900]] },
    gradients: {
      primary: [primitive.grey[50], primitive.bw.white],
      secondary: [primitive.red[50], primitive.bw.white],
    },
  ...
  buttons: {
    surface: primitive.grey[50],
    surfacePrimary: primitive.bw.black,
    textOnSurface: primitive.grey[900],
    textOnPrimary: primitive.bw.white,
  },
...
const darkColors: ColorScheme = {
  ...
  buttons: {
    surface: primitive.grey[800],
    surfacePrimary: primitive.bw.white,
    textOnSurface: primitive.bw.white,
    textOnPrimary: primitive.bw.black,
  },
